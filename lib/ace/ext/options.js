...
export const OptionPanel = function(editor, element) {
    this.editor = editor;
...
(function() {
    ...
    this.render = function() {
        ...
        dom.buildDom(["table", {role: "presentation", id: "controls"},
