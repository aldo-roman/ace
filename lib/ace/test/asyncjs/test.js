...
import * as oop from "ace/lib/oop";
import * as async from "asyncjs/async";
import "asyncjs/utils";

export const TestGenerator = function(source) {
    async.Generator.call(this, source)
}

oop.inherits(TestGenerator, async.Generator)
...
}).call(TestGenerator.prototype)

export const testcase = function(testcase, suiteName, timeout) {
    var methods = []
    ...
    return async.list(tests, TestGenerator)
}
