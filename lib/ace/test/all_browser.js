import "ace/lib/fixoldbrowsers"
import * as mockdom from "../test/mockdom";
import {test as AsyncTest} from "asyncjs";
import * as async from "asyncjs";
...
if (location.search.indexOf("show=1") != -1) {
    Promise.all([import("ace/virtual_renderer"), import("ace/test/mockrenderer")]).then(function (real, mock) {
...
import(testNames).then(function() {
    var tests = testNames.map(async function(x) {
