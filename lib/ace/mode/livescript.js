...
import * as MatchingBraceOutdent from '../mode/matching_brace_outdent';
import {CstyleBehaviour} from "./behaviour/cstyle";
import {Mode as TextMode} from './text';
  var identifier, LiveScriptMode, keywordend, stringfill;
  identifier = '(?![\\d\\s])[$\\w\\xAA-\\uFFDC](?:(?!\\s)[$\\w\\xAA-\\uFFDC]|-[A-Za-z])*';
  export const Mode = LiveScriptMode = (function(superclass){
    ...
    function LiveScriptMode(){
      var that;
      this.$tokenizer = new (Tokenizer).Tokenizer(LiveScriptMode.Rules);
      if (that = MatchingBraceOutdent) {
